    ...
    const fetchData = async () => {
      try {
        const [tenderRes, directRes] = await Promise.all([
          axios.get<{ data: TenderProduct[] }>('/tender/getTendersByProductsAndCompany'),
          axios.get<{ data: DirectProcurementProduct[] }>('/directProcurement/getDirectsByCompanyAndProducts')
        ]);
  ...
  const handleApproveAll = async () => {
    ...
    try {
      ...
      for (const demand of tenderDemands) {
        await axios.post('/materialDemand/create', {
      ...
      for (const demand of directDemands) {
        await axios.post('/materialDemand/create/directProcurement', {
