...
const DepoHomePage: React.FC = () => {
  ...
  const fetchStockData = async () => {
    try {
      ...
      const response = await axios.get('/v1/materialEntry/getAllProductDetail');
  ...
  const fetchRecentEntries = async () => {
    try {
      const response = await axios.get('/v1/materialEntry/all');
  ...
  const fetchRecentExits = async () => {
    try {
      const response = await axios.get('/v1/materialExit/all');
