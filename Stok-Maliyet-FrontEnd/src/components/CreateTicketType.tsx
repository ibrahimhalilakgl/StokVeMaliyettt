...
const TicketTypeList: React.FC = () => {
  ...
  const fetchTypes = async () => {
    try {
      const response = await axios.get('/v1/ticketType/all');
  ...
  const handleCreateType = async () => {
    ...
    try {
      await axios.post('/v1/ticketType/create', {
  ...
  const handleUpdateType = async () => {
    ...
    try {
      await axios.put('/v1/ticketType/update', {
        id: editType.id,
  ...
  const handleDeleteType = async () => {
    ...
    try {
      await axios.delete(`/v1/ticketType/delete/${ticketToDelete.id}`);
