...
const CreateTenderForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axios.get('/purchasedUnit/all').then(res => setPurchasedUnits(res.data.data));
    axios.get('/purchaseType/all').then(res => setPurchaseTypes(res.data.data));
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post('/tender/create', payload);
